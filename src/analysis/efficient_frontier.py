...
def get_portfolio_suggestions(
    ...
    suggestions['max_sharpe'] = {
        ...
        'description_jp': 'リスク調整後リターンが最も高い配分',
...
def prepare_data_for_frontier(
    ...
    # This assumes the last known price persists until new data is available,
