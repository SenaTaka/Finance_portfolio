# Finance Portfolio マネジメントシステム

モダンポートフォリオ理論を使用した、包括的でモジュール化されたポートフォリオ管理システムです。ポートフォリオの評価、最適化、分析をサポートします。

> 📘 **English Documentation** | [README.md](readme.md) | [ARCHITECTURE.md](ARCHITECTURE.md) | [MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)

## ⚠️ 重要：新しいモジュールアーキテクチャ

このプロジェクトは、スケーラビリティとメンテナンス性の向上のため、モジュールアーキテクチャにリファクタリングされました。詳細は[ARCHITECTURE.md](ARCHITECTURE.md)を、移行手順は[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)をご覧ください。
...
- [MIGRATION_GUIDE.md](MIGRATION_GUIDE.md) - 旧構造からの移行
...
完全な移行手順については、[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)をご覧ください。
...
問題や質問がある場合：
1. [ARCHITECTURE.md](ARCHITECTURE.md)と[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)を確認
